...
int main() {
    ...
    if (message >= n) {
        printf("Message must be less than %d (n). Exiting.\n", n);
        return 1;
    }
...
![Screenshot 2025-04-24 070346](https://github.com/user-attachments/assets/40f898e8-4627-454c-b0b7-0d788ab5f2d3)
